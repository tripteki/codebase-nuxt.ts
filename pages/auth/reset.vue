    ...
    <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm light:bg-neutral-900 light:border-neutral-700">
        <div class="p-4 sm:p-7">
            ...
            <form>
                ...
                <!-- New Password Form -->
                <div>
                    <label for="password" class="block text-sm mb-2 light:text-white">New Password</label>
                    <div class="relative">
                ...
                <div>
                    <label for="confirm-password" class="block text-sm mb-2 light:text-white">New Password Confirmation</label>
                    <div class="relative">
                ...
                <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Reset</button>
                </div>
            </form>
            <!-- End Form -->
